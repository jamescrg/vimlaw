...
# route posts every message to prod AND dev; prod processes intake-kosmos@,
# dev processes intake-kosmos-dev@, each dropping the other's mail. This is what makes
# permanent integration testing against dev possible on a 1-route quota.
INTAKE_INBOUND_RECIPIENT = env(
    "INTAKE_INBOUND_RECIPIENT", default="intake-kosmos"
).lower()
