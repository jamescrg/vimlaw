...
urlpatterns = [
    ...
    path(
        "filter/update", views.filter_update, name="agenda-filter-update"
    ),

    path(
        "filter/sort/<str:new_field>", views.filter_sort, name="agenda-filter-sort"
    ),
