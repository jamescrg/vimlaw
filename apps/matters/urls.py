...
urlpatterns = [
    ...
    path("matters/<int:id>/edit-description", edit_description, name="edit-description"),
    ...
    path("matters/<int:id>/contacts/assign/results", contacts.assign_results, name="contacts-assign-results"),
    path("matters/<int:matter_id>/assign/<int:contact_id>", contacts.assign_role, name="contacts-assign-role"),
    ...
    path("matters/assign/<id>/update", contacts.assign_update, name="contacts-assign-update"),
    path("matters/assign/<id>/delete", contacts.assign_delete, name="contacts-assign-delete"),

    # Rates
    path("matters/<int:id>/rates", matters_rates.index, name="rates"),
    path("matters/<int:id>/rates/add", matters_rates.add, name="rates-add"),
    path("matters/<int:id>/rates/<int:rate_id>/edit", matters_rates.edit, name="rates-edit"),
    path("matters/<int:matter_id>/rates/<int:rate_id>/delete", matters_rates.delete, name="rates-delete"),
    ...
    path("matters/<int:id>/proceedings/<int:proceeding_id>/edit", proceedings.edit, name="proceedings-edit"),
    path(
        "matters/<int:matter_id>/proceedings/<int:proceeding_id>/delete",
        proceedings.delete, name="proceedings-delete"),
    ...
    path("matters/<int:id>/settlement/<int:entry_id>/edit", settlement.edit, name="settlement-edit"),
    path("matters/<int:matter_id>/settlement/<int:entry_id>/delete", settlement.delete, name="settlement-delete"),

    # Timeline
    path("matters/<int:id>/timeline", timeline.index, name="timeline"),
    path("matters/<int:id>/timeline/add", timeline.add, name="timeline-add"),
    path("matters/<int:id>/timeline/<int:fact_id>/edit", timeline.edit, name="timeline-edit"),
    path("matters/<int:matter_id>/timeline/<int:fact_id>/delete", timeline.delete, name="timeline-delete"),
