...
urlpatterns = [
    ...
    path("events/deadline-results", events_deadline_results, name="events-deadline-results"),
    path("events/add/<int:matter_id>", events_add, name="events-add-matter"),
    path("events/add/<int:matter_id>/<str:origin>", events_add, name="events-add-matter-origin"),
    ...
    path("events/<int:id>/delete/<str:origin>", events_delete, name="events-delete-origin"),
    path("events/filter/", events_filter, name="events-filter"),
    path("events/filter/quick/<str:quick_filter>", events_filter_quick, name="events-filter-quick"),
]
# fmt: on
